...
export const useNetworkData = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      //   const [networkStats, apps, traffic] = await Promise.all([
      //     window.electronAPI.network.getNetworkStats(),
      //     window.electronAPI.network.getAppUsage(),
      //     window.electronAPI.network.getTrafficTypes(),
      //   ]);
      //   
      //   setNetworkData(networkStats);
      //   setAppUsage(apps);
      //   setTrafficTypes(traffic);
      // }
